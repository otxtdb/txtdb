...
- [categories\_as\_tabs:](https://docs.searxng.org/admin/settings/settings_categories_as_tabs.html#settings-categories-as-tabs)
- [引擎概述](https://docs.searxng.org/dev/engines/engine_overview.html#engines-dev)
- [engines:](https://docs.searxng.org/admin/settings/settings_engines.html#settings-engines)
- [通用引擎配置](https://docs.searxng.org/dev/engines/engine_overview.html#general-engine-configuration)

SearXNG 支持 245 个搜索引擎，其中 89 个默认启用。

引擎可以被分配到多个 [类别](https://docs.searxng.org/admin/settings/settings_engines.html#engine-categories) 。界面显示在 [categories\_as\_tabs](https://docs.searxng.org/admin/settings/settings_categories_as_tabs.html#settings-categories-as-tabs) 中配置的选项卡。除了这些界面类别（也称为 *选项卡* ），还可以通过引擎的名称或它们所属的类别进行查询，使用 [!bing 语法](https://docs.searxng.org/user/search-syntax.html#search-syntax) 。

- [选项卡 `!general`](https://docs.searxng.org/user/#tab-general)
	- [分组 `!books`](https://docs.searxng.org/user/#group-books)
	- [group `!currency`](https://docs.searxng.org/user/#group-currency)
	- [group `!translate`](https://docs.searxng.org/user/#group-translate)
	- [组 `!web`](https://docs.searxng.org/user/#group-web)
	- [组 `!wikimedia`](https://docs.searxng.org/user/#group-wikimedia)
	- [无进一步子分组](https://docs.searxng.org/user/#without-further-subgrouping)
- [tab `!images`](https://docs.searxng.org/user/#tab-images)
	- [group `!icons`](https://docs.searxng.org/user/#group-icons)
	- [group `!web`](https://docs.searxng.org/user/#id2)
	- [不进行进一步的子分组](https://docs.searxng.org/user/#id3)
- [tab `!videos`](https://docs.searxng.org/user/#tab-videos)
	- [group `!web`](https://docs.searxng.org/user/#id4)
	- [无需进一步分组](https://docs.searxng.org/user/#id5)
- [tab `!news`](https://docs.searxng.org/user/#tab-news)
	- [group `!web`](https://docs.searxng.org/user/#id6)
	- [group `!wikimedia`](https://docs.searxng.org/user/#id7)
	- [不进行更细的子分组](https://docs.searxng.org/user/#id8)
- [tab `!map`](https://docs.searxng.org/user/#tab-map)
- [tab `!music`](https://docs.searxng.org/user/#tab-music)
	- [group `!lyrics`](https://docs.searxng.org/user/#group-lyrics)
	- [group `!radio`](https://docs.searxng.org/user/#group-radio)
	- [不进行进一步的子分组](https://docs.searxng.org/user/#id10)
- [tab `!it`](https://docs.searxng.org/user/#tab-it)
	- [group `!packages`](https://docs.searxng.org/user/#group-packages)
	- [group `!q&a`](https://docs.searxng.org/user/#group-q-a)
	- [group `!repos`](https://docs.searxng.org/user/#group-repos)
	- [group `!software_wikis`](https://docs.searxng.org/user/#group-software-wikis)
	- [无需进一步分组](https://docs.searxng.org/user/#id12)
- [tab `!science`](https://docs.searxng.org/user/#tab-science)
	- [group `!scientific_publications`](https://docs.searxng.org/user/#group-scientific-publications)
	- [group `!wikimedia`](https://docs.searxng.org/user/#id13)
	- [无需进一步分组](https://docs.searxng.org/user/#id15)
- [tab `!files`](https://docs.searxng.org/user/#tab-files)
	- [group `!apps`](https://docs.searxng.org/user/#group-apps)
	- [group `!books`](https://docs.searxng.org/user/#id16)
	- [无需进一步分组](https://docs.searxng.org/user/#id17)
- [tab `!social_media`](https://docs.searxng.org/user/#tab-social-media)

## [tab `!general`](https://docs.searxng.org/user/configured_engines.html#id19)[](https://docs.searxng.org/user/configured_engines.html#tab-general "Link to this heading")

### [group `!books`](https://docs.searxng.org/user/configured_engines.html#id20)[](https://docs.searxng.org/user/configured_engines.html#group-books "Link to this heading")
