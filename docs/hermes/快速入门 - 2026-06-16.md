...
![](https://www.youtube.com/watch?v=R3YOGfTBcQg)
...
> Android / Termux
> 
> 如果你在手机上安装，请参阅专门的 [Termux 指南](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/termux) ，其中包含经过测试的手动安装步骤、支持的扩展功能以及当前 Android 特有的限制。
...
详细的安装选项、前置条件和故障排查，请参阅 [安装指南](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/installation) 。
...
> 最简路径：Nous Portal
> 
> 一个订阅涵盖 300+ 个模型，以及 [Tool Gateway](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/tool-gateway) （网页搜索、图像生成、TTS、云端浏览器）。全新安装时：
> 
> ```bash
> hermes setup --portal
> ```
...
| **AWS Bedrock** | 通过原生 Converse API 使用 Claude、Nova、Llama、DeepSeek | IAM 角色或 `aws configure` （ [指南](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/aws-bedrock) ） |
...
对于大多数初次使用的用户：选择一个 provider，接受默认值（除非你明确知道为何要修改）。完整的 provider 目录及环境变量和配置步骤请参阅 [Providers](https://hermes-agent.nousresearch.com/docs/zh-Hans/integrations/providers) 页面。
...
> 提示
> 
> 你可以随时通过 `hermes model` 切换 provider——没有锁定。所有支持的 provider 完整列表及配置详情，请参阅 [AI Providers](https://hermes-agent.nousresearch.com/docs/zh-Hans/integrations/providers) 。
...
> 选择你的界面
> 
> Hermes 提供两种终端界面：经典的 `prompt_toolkit` CLI，以及更新的 [TUI](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui) （支持模态覆盖层、鼠标选择和非阻塞输入）。两者共享相同的会话、斜杠命令和配置——分别用 `hermes` 和 `hermes --tui` 试试看。
...
接入 [Telegram](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram) 、 [Discord](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord) 、 [Slack](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack) 、 [WhatsApp](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp) 、 [Signal](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal) 、 [Email](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email) 、 [Home Assistant](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/homeassistant) 或 [Microsoft Teams](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams) 。
...
然后在 CLI 中输入： `/voice on` 。按 `Ctrl+B` 开始录音。参阅 [语音模式](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/voice-mode) 。
...
参阅 [ACP 编辑器集成](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/acp) 。
...
- **[CLI 指南](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli)** — 掌握终端界面
- **[配置](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration)** — 自定义你的配置
- **[消息 Gateway](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/)** — 接入 Telegram、Discord、Slack、WhatsApp、Signal、Email、Home Assistant、Teams 等
- **[工具与工具集](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/tools)** — 探索可用功能
- **[AI Providers](https://hermes-agent.nousresearch.com/docs/zh-Hans/integrations/providers)** — 完整 provider 列表及配置详情
- **[Skills 系统](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills)** — 可复用的工作流与知识
- **[技巧与最佳实践](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/tips)** — 高级用户技巧