...
source: "https://github.com/D4Vinci/Scrapling/blob/main/docs/README_CN.md"
author:
published:
created: 2026-07-26
...
[**选择方法**](https://scrapling.readthedocs.io/en/latest/parsing/selection.html) · [**选择 Fetcher**](https://scrapling.readthedocs.io/en/latest/fetching/choosing.html) · [**爬虫**](https://scrapling.readthedocs.io/en/latest/spiders/architecture.html) · [**代理轮换**](https://scrapling.readthedocs.io/en/latest/spiders/proxy-blocking.html) · [**CLI**](https://scrapling.readthedocs.io/en/latest/cli/overview.html) · [**MCP 模式**](https://scrapling.readthedocs.io/en/latest/ai/mcp-server.html)
...
[![At DataImpulse, we specialize in developing custom proxy services for your business. Make requests from anywhere, collect data, and enjoy fast connections with our premium proxies.](https://raw.githubusercontent.com/D4Vinci/Scrapling/main/images/DataImpulse.png)](https://dataimpulse.com/?utm_source=scrapling&utm_medium=banner&utm_campaign=scrapling)

## 铂金赞助商

| [![](https://raw.githubusercontent.com/D4Vinci/Scrapling/main/images/NodeMaven.jpg)](https://go.nodemaven.com/scraplingjuly "Proxies with the Highest IP Scores") | [NodeMaven](https://go.nodemaven.com/scraplingjuly) - 市场上 IP 质量最高的可靠代理提供商。使用优惠码 SCRAPLING35 可享代理 35% 折扣。 |
| --- | --- |
| [![](https://raw.githubusercontent.com/D4Vinci/Scrapling/main/images/proxidize.png)](https://proxidize.com/?utm_source=github&utm_medium=sponsorship&utm_campaign=scrapling&utm_content=d4vinci "Clean Proxies with No Nonsense.") | [**Proxidize**](https://proxidize.com/?utm_source=github&utm_medium=sponsorship&utm_campaign=scrapling&utm_content=d4vinci) 提供移动代理和住宅代理，适用于网页抓取、浏览器自动化、SEO 监控、AI 代理和数据收集。 *使用优惠码 **scrapling20** 可享 20% 折扣* 。 |
| [![](https://raw.githubusercontent.com/D4Vinci/Scrapling/main/images/coldproxy.png)](https://coldproxy.com/?utm_source=scrapling&utm_medium=github&utm_campaign=coldproxy&utm_content=platinum_sponsor "Residential, IPv6 & Datacenter Proxies for Web Scraping") | [**ColdProxy**](https://coldproxy.com/?utm_source=scrapling&utm_medium=github&utm_campaign=coldproxy&utm_content=platinum_sponsor) 提供住宅代理和数据中心代理，用于稳定的网络抓取、公共数据收集，以及覆盖 195 多个国家/地区的地理定向测试。 |
| [![](https://raw.githubusercontent.com/D4Vinci/Scrapling/main/images/HyperSolutions.png)](https://hypersolutions.co/?utm_source=github&utm_medium=readme&utm_campaign=scrapling "Bot Protection Bypass API for Akamai, DataDome, Incapsula & Kasada") | Scrapling 可处理 Cloudflare Turnstile。对于企业级保护， [**Hyper Solutions**](https://hypersolutions.co/?utm_source=github&utm_medium=readme&utm_campaign=scrapling) 提供 API 端点，生成适用于 **Akamai** 、 **DataDome** 、 **Kasada** 和 **Incapsula** 的有效 antibot 令牌。简单的 API 调用，无需浏览器自动化。 |
...
| [![](https://raw.githubusercontent.com/D4Vinci/Scrapling/main/images/TikHub.jpg)](https://tikhub.io/?utm_source=github.com/D4Vinci/Scrapling&utm_medium=marketing_social&utm_campaign=retargeting&utm_content=carousel_ad "Unlock the Power of Social Media Data & AI") | [TikHub.io](https://tikhub.io/?utm_source=github.com/D4Vinci/Scrapling&utm_medium=marketing_social&utm_campaign=retargeting&utm_content=carousel_ad) 提供覆盖 16+ 平台（包括 TikTok、X、YouTube 和 Instagram）的 900+ 稳定 API，拥有 4000 万+ 数据集。   还提供 [优惠 AI 模型](https://ai.tikhub.io/?ref=KarimShoair) - Claude、GPT、GEMINI 等，最高优惠 71%。 |
| [![](https://raw.githubusercontent.com/D4Vinci/Scrapling/main/images/petrosky.png)](https://petrosky.io/d4vinci "PetroSky delivers cutting-edge VPS hosting.") | 合上笔记本电脑，您的爬虫仍在运行。   [PetroSky VPS](https://petrosky.io/d4vinci) - 为不间断自动化而生的云服务器。Windows 和 Linux 系统，完全掌控。低至 €6.99/月。 |
| [![](https://raw.githubusercontent.com/D4Vinci/Scrapling/main/images/TWSC.png)](https://substack.thewebscraping.club/p/scrapling-hands-on-guide?utm_source=github&utm_medium=repo&utm_campaign=scrapling "The #1 newsletter dedicated to Web Scraping") | 阅读 [The Web Scraping Club 上关于 Scrapling 的完整评测](https://substack.thewebscraping.club/p/scrapling-hands-on-guide?utm_source=github&utm_medium=repo&utm_campaign=scrapling) （2025 年 11 月），这是排名第一的网页抓取专业通讯。 |
| [![](https://raw.githubusercontent.com/D4Vinci/Scrapling/main/images/SwiftProxy.png)](https://www.swiftproxy.net/?ref=D4Vinci "Scalable Solutions for Web Data Access") | [Swiftproxy](https://www.swiftproxy.net/?ref=D4Vinci) 提供可扩展的住宅代理，覆盖 195+ 国家/地区的 8000 万+ IP，提供快速可靠的连接、自动轮换和强大的反屏蔽性能。提供免费试用。 |

*<sub>想在这里展示您的广告吗？点击 <a href="https://github.com/sponsors/D4Vinci/sponsorships?tier_id=586646">这里</a></sub>*

## 赞助商

[![](https://raw.githubusercontent.com/D4Vinci/Scrapling/main/images/SerpApi.png)](https://serpapi.com/?utm_source=scrapling "Scrape Google and other search engines with SerpApi") [![](https://raw.githubusercontent.com/D4Vinci/Scrapling/main/images/decodo.png)](https://visit.decodo.com/Dy6W0b "Try the Most Efficient Residential Proxies for Free") [![](https://raw.githubusercontent.com/D4Vinci/Scrapling/main/images/hasdata.png)](https://hasdata.com/?utm_source=github&utm_medium=banner&utm_campaign=D4Vinci "The web scraping service that actually beats anti-bot systems!") [![](https://raw.githubusercontent.com/D4Vinci/Scrapling/main/images/ProxyEmpire.png)](https://proxyempire.io/?ref=scrapling&utm_source=scrapling "Collect The Data Your Project Needs with the Best Residential Proxies") [![](https://raw.githubusercontent.com/D4Vinci/Scrapling/main/images/webshare.png)](https://www.webshare.io/?referral_code=48r2m2cd5uz1 "The Most Reliable Proxy with Unparalleled Performance") [![](https://raw.githubusercontent.com/D4Vinci/Scrapling/main/images/proxiware.png)](https://proxiware.com/?ref=scrapling "Collect Any Data. At Any Scale.")

*<sub>想在这里展示您的广告吗？点击 <a href="https://github.com/sponsors/D4Vinci">这里</a> 并选择适合您的级别！</sub>*
...
[![asciicast](https://camo.githubusercontent.com/1d3d0329e875695bf7699e1e6c08383df0afa2e8c8f4d86184789b39055cfadc/68747470733a2f2f61736369696e656d612e6f72672f612f3733363333392e737667)](https://asciinema.org/a/736339)
